...
#if QUADRATIC_HYPERBOLIC_PARABOLOID_LOG == 1
        std::cout << "-------------quadratic_hyperbolic_paraboloid::hit----------------" << endl;
#endif // QUADRATIC_HYPERBOLIC_PARABOLOID_LOG
            ...
            if (B == 0) {
                ...
                if (temp < t_max && temp > t_min) {
                    ...
                    if ((((rec.p.y()-center.y()) > -height_half_y) && ((rec.p.y()-center.y()) < height_half_y))
                        && (((rec.p.x()-center.x()) > -width_x) && ((rec.p.x()-center.x()) < width_x)) ) {
                        pc = rec.p - center;
